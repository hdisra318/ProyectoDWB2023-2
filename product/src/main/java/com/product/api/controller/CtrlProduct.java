...
public class CtrlProduct {
	...
	// Implementacion para List Products
	@GetMapping("/category/{category_id}")
	public ResponseEntity<List<DtoProductList>> getListProducts(@PathVariable("category_id") Integer category_id){
	...
	// Implementacion para Update Product Category
	...
	public ResponseEntity<ApiResponse> updateProductCategory(@PathVariable("gtin") String gtin, @RequestBody Category in){
		...
		return new ResponseEntity<>(svc.updateProductCategory(in.getCategory_id(), gtin), HttpStatus.OK);
	}
